...
const Admin = () => {
  ...
  useEffect(() => {
    const fetchTodayAttendance = async () => {
      setLoading(true);
      try {
        const res = await fetch("https://attendify-backend-vmyr.onrender.com/api/attendance/today");
  ...
  const fetchAttendanceHistory = async () => {
    ...
    setShowHistory(true);
    try {
      const res = await fetch("https://attendify-backend-vmyr.onrender.com/api/attendance/history");
      const data = await res.json();
      if (res.ok) {
