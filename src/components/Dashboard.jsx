    ...
    const checkStatus = async () => {
      ...
      try {
        ...
        const faceDataRes = await fetch(
          `https://attendify-backend-vmyr.onrender.com/check-face-data-presence/${studentId}`,
          {
            method: "GET",
            headers: {
        ...
        if (faceDataResult.hasFaceData) {
          const attendanceRes = await fetch(
            `https://attendify-backend-vmyr.onrender.com/is-todays-attendance-marked/${studentId}`,
            {
              method: "GET",
              headers: {
                Authorization: `Bearer ${token}`,
